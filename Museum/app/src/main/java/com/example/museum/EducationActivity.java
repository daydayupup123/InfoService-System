...
public class EducationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView imageView = (ImageView)findViewById(R.id.Appbar_imageview_education);
        TextView educationName = (TextView)findViewById(R.id.education_name);
        TextView educationTime = (TextView)findViewById(R.id.education_time);
        TextView educationLocation = (TextView)findViewById(R.id.education_location);
        CollapsingToolbarLayout collapsingToolbarLayout = (CollapsingToolbarLayout)findViewById(R.id.collapsing_bar_education);
